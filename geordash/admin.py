...
@admin_bp.route("/")
def index() -> str:
    all_jobs_for_msconfigs = rcli.get_taskids_by_taskname_and_args('geordash.checks.mapstore.check_configs',[])
    all_jobs_for_msresources = rcli.get_taskids_by_taskname_and_args('geordash.checks.mapstore.check_resources',[])
