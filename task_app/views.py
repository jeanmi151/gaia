...
def result(id: str) -> dict[str, object]:
    ...
    if result is None:
        ...
        if type(result.result) == list and result.name in ('task_app.checks.mapstore.check_resources', 'task_app.checks.ows.check_owsservice', 'task_app.checks.csw.check_catalog'):
